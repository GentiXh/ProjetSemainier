...
public class Recette extends JFrame {
	...
	public Recette(){ //constructeur
		...
		TriDeContraintes t = new TriDeContraintes(fenAllergie.regime, fenAllergie.gluten, fenAllergie.oeuf, fenAllergie.lactose, fenAllergie.arachide, fenAllergie.fodmap, type); 
		t.Tri();
